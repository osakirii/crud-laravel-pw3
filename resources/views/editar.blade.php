    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/listar">Editar</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/listar">Deletar</a>
                    </li>
                </div>
            </div>
            </nav>
            ...
            <form action="/editar-cliente/{{ $cliente->id }}" class="container" method="POST">
                @csrf
                ...
                <div class="container mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" name="origem" id="inputOrigin1" value="{{ $cliente->origem }}">

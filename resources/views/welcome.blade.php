    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/deletar">Deletar</a>
                    </li>
                </div>
            </div>
            </nav>
            ...
            <form action="/cadastrar-cliente" class="container" method="POST">
                @csrf
                 <div class="container mb-3">
                    <label for="inputName" class="form-label">Nome</label>
                    <input type="text" class="form-control" name="nome" id="inputName1">
                </div>
                <div class="container mb-3">
                    <label for="inputPhoneNumber" class="form-label">Telefone</label>
                    <input type="text" class="form-control" name="telefone" id="inputPhoneNumber1">
                </div>
                <div class="container mb-3">
                    <label for="inputOrigin" class="form-label">Origem</label>
                    <select class="form-select" aria-label="Default select example" name="origem" id="inputOrigin1">
                ...
                <div class="container mb-3">
                    ...
                    <input type="date" class="form-control" name="data" id="inputDate1">
                </div>
                <div class="container mb-3">
                    <label for="inputObs" class="form-label">Observações</label>
                    <textarea class="form-control" name="obs" id="inputObs1" rows="5"></textarea>
                </div>
